...
# Source tarball is generated by cloning the repo in %%prep
Source0: ayugram-desktop-git.tar.gz
...
%prep
# Clone AyuGram Desktop source from upstream repo
git clone --depth=1 --recursive --shallow-submodules \
    https://github.com/Bourbon24k/AyuGramDesktop-6.9.3.git AyuGramDesktop-full
cd AyuGramDesktop-full
%patch0 -p1
%patch1 -p1
%patch2 -p1
